...
\item \textbf{Hu, C.}, Pozdnyakov, V., and Yan, J. (2019). ``Density and Distribution Evaluation for Convolution of Independent Gamma Variables.'' \textit{Computational Statistics}. (doi:10.1007/s00180-019-00924-9)
...
\item Rath, A., Mishra, A., Ferreira, V.D., \textbf{Hu, C.}, Omerza, G., Kelly, K., Hesse, A., Reddi, H., Grady, J.P., and Heinen, C.D. (2019). ``Functional Interrogation of Lynch Syndrome Associated MSH2 Missense Variants via CRISPR-Cas9 Gene Editing in Human Embryonic Stem Cells.'' \textit{Human Mutation}. (doi:10.1002/humu.23848)
